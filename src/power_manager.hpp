...
class PowerManager
{
  ...
  private:
     ...
     * @param[in] methodObj - sdbus message object to which input data
     * parameters are appended in order to issue method call
     *
     */
    ...
    /** @brief Handler to add OEM specific Parameters to the Dbus Method Calls
     * of action/conditon Blocks */
